...
subplot(2,4,1);
axh1 = axis();
gamDistA = sort(random('Gamma', 0.1, 1.0, numPoints, 1));
...
subplot(2,4,3);
axh3 = axis();
gamDistA = sort(random('Gamma', 1.0, 1.0, numPoints, 1));
...
subplot(2,4,5);
axh5 = axis();
gamDistA = sort(random('Gamma', 10.0, 1.0, numPoints, 1));
h5gam  = plot(gamDistA, normalDist,'b-','linewidth',2.0);
ylim([-3 3]);
%set(axh1, 'FontSize', 18);
subplot(2,4,6);
axh6 = axis();
gamDistA = sort(random('Gamma', 25, 1.0, numPoints, 1));
h6gam  = plot(gamDistA, normalDist,'b-','linewidth',2.0);
ylim([-3 3]);
%set(axh2, 'FontSize', 18);
subplot(2,4,7);
axh7 = axis();
gamDistA = sort(random('Gamma', 50, 1.0, numPoints, 1));
h7gam  = plot(gamDistA, normalDist,'b-','linewidth',2.0);
ylim([-3 3]);
%set(axh3, 'FontSize', 18);
subplot(2,4,8);
axh8 = axis();
gamDistA = sort(random('Gamma', 100, 1.0, numPoints, 1));
h8gam  = plot(gamDistA, normalDist,'b-','linewidth',2.0);
ylim([-3 3]);
%set(axh4, 'FontSize', 18);
clearvars gamDistA;
%% Inverse Gaussian distribution
figure('Name','Inv. Gaussian')
figCnt = figCnt + 1;
subplot(2,2,1);
axh1 = axis();
